 ...
 */
class MoskitoPeacemanBoreholeMassProS : public Kernel
{
public:
  /**
   * Creates a new MoskitoPeacemanBoreholeMassProS
  ...
  MoskitoPeacemanBoreholeMassProS(const InputParameters & parameters);
