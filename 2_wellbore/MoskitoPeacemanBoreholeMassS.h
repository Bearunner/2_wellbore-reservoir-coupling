 ...
 */
class MoskitoPeacemanBoreholeMassS : public Kernel
{
public:
  /**
   * Creates a new MoskitoPeacemanBoreholeMassS
  ...
  MoskitoPeacemanBoreholeMassS(const InputParameters & parameters);
