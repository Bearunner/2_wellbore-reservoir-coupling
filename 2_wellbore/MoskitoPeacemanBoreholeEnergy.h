 ...
 */
class MoskitoPeacemanBoreholeEnergy : public Kernel
{
public:
  /**
   * Creates a new MoskitoPeacemanBoreholeEnergy
  ...
  MoskitoPeacemanBoreholeEnergy(const InputParameters & parameters);
