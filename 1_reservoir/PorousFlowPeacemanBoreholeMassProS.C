...
#include "PorousFlowPeacemanBoreholeMassProS.h"
#include "Function.h"

registerMooseObject("PorousFlowApp", PorousFlowPeacemanBoreholeMassProS);

InputParameters
PorousFlowPeacemanBoreholeMassProS::validParams()
{
...
PorousFlowPeacemanBoreholeMassProS::PorousFlowPeacemanBoreholeMassProS(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
PorousFlowPeacemanBoreholeMassProS::computeQpResidual()
{
    Real r = 0.0;
...
Real
PorousFlowPeacemanBoreholeMassProS::computeQpJacobian()
{
...
Real
PorousFlowPeacemanBoreholeMassProS::computeQpOffDiagJacobian(unsigned int jvar)
{
...
Real
PorousFlowPeacemanBoreholeMassProS::computeQpJac(unsigned int pvar)
{
Real j = 0.0;
